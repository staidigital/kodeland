...
<aside 
class="lg:w-72 w-full bg-slate-800/90 lg:pt-32 shadow-xl z-20"
...
<nav class="menu flex flex-col gap-4 p-8 lg:fixed w-full break-words overflow-hidden">
      <div class="text-fuchsia-300 font-bold text-lg mb-2 tracking-wide">
        <slot name="title">Innhold</slot>
      </div>
      ...
      {#each sections as section}
        <div class="mb-2">
          <a
            ...
            class={`text-md font-semibold tracking-wide block transition break-words whitespace-normal overflow-hidden
              ...
              {#each section.links as item}
                <li>
                  <a
                    ...
                    class="text-white hover:text-fuchsia-400 transition px-1 py-0.5 block text-md break-words whitespace-normal overflow-hidden"
                  >
                    {item.text}
                  </a>
